        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    ...
                    String cpf = "044.021.081-01";
                    String email = "tallys.henrike@gmail.com";
                    String sexo = "Masculino";
                    String cep = "75370-000";
                    String logradouro = "Rua 10";
                    String complemento = "Vazio";
                    String bairro = "Residencial Triunfo";
                    String cidade = "Goianira";
                    String uf = "GO";
